    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-col-cyan pull-right">
                ...
                <li><a href="{{ route('schedule_manage',['id'=>$infos['sells_id']]) }}"><i class="material-icons">schedule</i>
                        ...
                        <div class="header">
                            ...
                            <div class="body">
                                <form class="form" id="form_validation" method="post"
                                      action="{{ route('actual_payment.update',['id'=>$infos['id'] ,'sells_id'=>$infos['sells_id'] ]) }}">
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $infos['item']->received_amount  }}"
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $infos['item']->adjustment  }}" name="adjustment"
                                                           type="number"
                                                           class="form-control">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    <input readonly value="{{ $infos['item']->actual_amount }}"
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    <input value="{{ $infos['item']->made_of_payment  }}"
                                                           name="made_of_payment" type="text"
                                                           class="form-control">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                ...
                                                <div class="form-line">
                                                    <input value="{{ $infos['item']->cheque_no  }}" name="cheque_no"
                                                           type="text"
                                                           class="form-control">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $infos['item']->bank_name  }}" name="bank_name"
                                                           type="text"
                                                           class="form-control">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container">
                                                    ...
                                                    <input autocomplete="off"
                                                           value="{{ $infos['item']->date_of_collection }}"
