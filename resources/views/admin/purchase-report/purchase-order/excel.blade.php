    ...
    <div class="mid">
        ...
        @foreach($branches as $branch)
            <table class="table  table-bordered table-sm">
                ...
                <tr>
                    <th>#</th>
                    <th scope="col"><b>Purchase Id</b></th>
                    <th scope="col"><b>Requisition Id</b></th>
                    <th scope="col"><b>Vendor Id</b></th>
                    <th scope="col"><b>Media Name</b></th>
                    <th scope="col"><b>Issuing Date</b></th>
                    <th scope="col"><b>Date of Delevery</b></th>
