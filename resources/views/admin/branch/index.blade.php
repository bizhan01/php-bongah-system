        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-col-cyan pull-right">
                ...
                <li><a href="{{ route($ParentRouteName) }}"><i
                                class="{{ $breadcrumbMainIcon  }}"></i>پروژه ها</a></li>
                <li class="active"><i
                            class="material-icons">{{ $breadcrumbCurrentIcon }}</i>همه ی پروژه ها</li>
            </ol>
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <a @if ($trash_show==0)
                               ...
                               href="{{ route($ParentRouteName.'.trashed') }}">زباله دان({{ $ModelName::onlyTrashed()->count()  }}
                                )</a>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <select class="form-control" name="apply_comand_top" id="">
                                                <option value="0">فعالیت دسته جمعی</option>
                                                @if ($delete)
                                                    <option value="3">انتقال به زباله دان</option>
                                                    <option value="2">پاک کردن همیشگی</option>
                                                @endif
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        ...
                                        @foreach($items as $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->facing }}</td>
                                                <td>{{ $item->building_height }}</td>
                                                <td>{{ $item->land_area }}</td>
                                                <td>{{ $item->launching_date }}</td>
                                                <td>{{ $item->hand_over_date }}</td>
                                               ...
                                               {{--  <td>{{ $item->description }}</td> --}}
                                                ...
                                                <td class="tdTrashAction">
                                                    ...
                                                    <a @if ($pdf==0)
                                                       ...
                                                       data-toggle="tooltip"
                                                       data-placement="top" title="دانلود PDF"> <i
