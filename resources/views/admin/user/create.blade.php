        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-col-cyan pull-right">
                ...
                <li><a href="{{ route($ParentRouteName) }}"><i
                                class="{{ $breadcrumbMainIcon  }} "></i> مدیران سیستم</a>
                </li>
                <li class="active"><i
                            class="material-icons">{{ $breadcrumbCurrentIcon  }}</i> افزودن مدیر سیستم</li>
            </ol>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                افزودن مدیر سیستم
                                <smAll>اطلاعات مدیر سیستم را وارد کنید . مطمئن باشید که قبل از اضافه کردن مدیر ، مدیریت دسترسی ایجاد کرده باشید</smAll>
                                <smAll></smAll>
                            </h2>
