            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                <table class="table table-bordered table-sm">
                    ...
                    <tr>
                        ...
                        <th class="text-left">{{ $search_by['income_expense_group_name']  }}</th>
    ...
    <div class="mid">
        <div class="row">
            ...
            @foreach($particulars as $type_name=>$particular)
                ...
                <table class="table table-bordered table-sm table-hover  page-break">
                    <thead>
                    <tr>
            ...
            <table class="table table-bordered margin-t-50">
                <thead>
                <tr>
