                    ...
                    <table class="table table-bordered table-sm table-hover">
                        ...
                        @if (count($items['branches'])==$branch_number)
                            <tr>
                                ...
                                <th
                                    class="text-right font-s-20">{{  $transaction->convert_money_format($total_dr) }}</th>
                                <th
                                    class="text-right font-s-20">{{  $transaction->convert_money_format($total_cr) }}</th>
                            </tr>
                        @endif
                ...
                <table class="table table-bordered table-sm table-hover">
                    ...
                    <tr>
                        ...
                        <th
                            class="text-right font-s-20">{{  $transaction->convert_money_format($total_cr) }}</th>
                        <th
                            class="text-right font-s-20">{{  $transaction->convert_money_format($total_dr+$total_bank_cash_balance) }}</th>
                    </tr>
