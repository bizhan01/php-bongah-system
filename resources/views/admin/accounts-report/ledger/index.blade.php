...
@section('content')
    ...
    <section class="content">
        <div class="header">
            <h2 class="text-center">Ledger Manage</h2>
        </div>
                                            ...
                                            <div class="form-line">
                                                <select data-live-search="true" class="form-control show-tick"
                                                    ...
                                                    @if (App\IncomeExpenseHead::All()->count() >0 )
                                                        @foreach( App\IncomeExpenseHead::All() as $income_expense_head )
                                                            <option value="{{ $income_expense_head->id  }}">{{ $income_expense_head->name  }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select data-live-search="true" class="form-control show-tick"
                                                        name="branch_id">
                                                    <option value="0">Select Proejct Name</option>
                                                    @if (App\Branch::All()->count() >0 )
                                                        @foreach( App\Branch::All() as $Branch )
                                                            <option value="{{ $Branch->id  }}">{{ $Branch->name  }}</option>
                                                        @endforeach
                                            ...
                                            <div class="form-line">
                                                <select data-live-search="true" class="form-control show-tick"
                                                    ...
                                                    @if (App\BankCash::All()->count() >0 )
                                                        @foreach( App\BankCash::All() as $BankCash )
                                                            <option value="{{ $BankCash->id  }}">{{ $BankCash->name  }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </div>
