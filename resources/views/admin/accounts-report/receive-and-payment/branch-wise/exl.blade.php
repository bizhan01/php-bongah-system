                    ...
                    <table class="table table-bordered table-sm table-hover">
                        ...
                        @if (count($items['branches'])==$branch_number)
                            <tr>
                                ...
                                <th class="text-right">{{  $total_dr }}</th>
                                <th class="text-right">{{  $total_cr }}</th>
                            </tr>
                        @endif
                        </tbody>
                    </table>
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                <table class="table table-bordered table-sm table-hover">
                    ...
                    <tr>
                        <th  class="text-right" colspan="2">Grand Total Amount =</th>
                        <th class="text-right">{{  $total_cr }}</th>
                        <th class="text-right">{{ $total_dr+$total_bank_cash_balance }}</th>
                    </tr>
