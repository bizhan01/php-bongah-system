                ...
                <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                    ...
                    <table class="table table-bordered table-sm table-hover">
                        ...
                        <tr>
                            ...
                            <th colspan="2" class="text-center font-s-18">
                                {{ $branch->name  }}
                            </th>
                            <th class="text-center font-s-18" colspan="2">
                                @if ( !empty($search_by['from']) )
                                    From {{ date(config('settings.date_format'), strtotime($search_by['from']))  }}
                                    to {{ date(config('settings.date_format'), strtotime($search_by['to'])) }}
                                @else
            ...
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-12">
                <table class="table table-bordered table-sm table-hover">
                    ...
                    <tr>
                        ...
                        <th class="text-center font-s-20">
                            Closing Bank & Cash Balance
                        </th>
                        <th class="text-center font-s-20" colspan="2">
