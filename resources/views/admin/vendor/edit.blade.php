    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-col-cyan pull-right">
                ...
                <li class="active"><i
                            class="material-icons">{{ $breadcrumbCurrentIcon  }}</i> ویرایش فروشنده ها</li>
            </ol>
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <smAll>اطلاعات فروشنده را ویرایش کنید</smAll>
                            </h2>
                                ...
                                <form class="form" id="form_validation" method="post"
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $item->website  }}" name="website" type="text"
                                                        class="form-control">
