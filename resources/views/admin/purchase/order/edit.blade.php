                                ...
                                <form class="form" id="form_validation" method="post"
                                    ...
                                    <div class="row clearfix">
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach( App\Vendor::All() as $vendor )
                                                            <option @if ( $vendor->id == $item->vendor_id )
                                                                    selected
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input autocomplete="off" value="{{ $item->media_name }}"
                                                           name="media_name"
                                                           type="text"
                                                           class="form-control">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input autocomplete="off" value="{{ $item->note }}"
                                                           name="note"
                                                           type="text"
                                                           class="form-control">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input autocomplete="off" value="{{ $item->subject }}"
                                                           name="subject"
                                                           type="text"
                                                           class="form-control">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    ...
                                                    <textarea class="form-control" name="message_body"
                                                              id="">{{ $item->message_body }} This is an reference to your discussion had with us today, we are pleased to place an order for supplying Work order for Sylhet Sand at our project under the following terms & conditions.</textarea>
