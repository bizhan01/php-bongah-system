...
@section('content')
    ...
    <div class="mid_section">
            ...
            <div class="col-lg-12 col-sm-12 col-md-12 col-xl-12">
                <table class="table table-bordered table-sm">
                    ...
                    <tr>
                        ...
                        <th>{{ $transaction->convert_money_format( $items->amount)  }}</th>
                        <th></th>
                    </tr>
                    </tbody>
                </table>
        ...
        <div class="row mb-5">
            <div class="col-lg-12 col-sm-12 col-md-12 col-xl-12">
                <p>In word: <span class="font-w-b"> {{ $transaction->convert_number_to_words($items->amount) }}   {!! config('settings.currency_code') !!} </span>
                    only.
                </p>
            </div>
        </div>
