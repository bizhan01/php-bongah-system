...
$All = config('role_manage.PurchaseRQNConfirm.All');
$create = config('role_manage.PurchaseRQNConfirm.Create');
$delete = config('role_manage.PurchaseRQNConfirm.Delete');
$edit = config('role_manage.PurchaseRQNConfirm.Edit');
$pdf = config('role_manage.PurchaseRQNConfirm.Pdf');
$permanently_delete = config('role_manage.PurchaseRQNConfirm.PermanentlyDelete');
$restore = config('role_manage.PurchaseRQNConfirm.Restore');
$show = config('role_manage.PurchaseRQNConfirm.Show');
$trash_show = config('role_manage.PurchaseRQNConfirm.TrashShow');
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        ...
                                        @foreach($items as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ App\Employee::withTrashed()->find($item->employee_id)->name }}</td>
