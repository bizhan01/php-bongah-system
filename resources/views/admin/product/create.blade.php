    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-col-cyan pull-right">
                ...
                <li><a href="{{ route($ParentRouteName) }}"><i class="{{ $breadcrumbMainIcon  }} "></i>فایل ها</a>
                </li>
                <li class="active"><i
                            class="material-icons">{{ $breadcrumbCurrentIcon  }}</i>افزودن فایل</li>
            </ol>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                افزودن فایل
                                <smAll>مشخصات فایل را وارد کنید</smAll>
                            </h2>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                            name="branch_id">
                                                        <option value="0">مدل فایل</option>
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ old('car_parking_charge')  }}"
                                                           name="car_parking_charge" type="text"
                                                           class="form-control">
                                            ...
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ old('additional_work_charge')  }}"
                                                           ...
                                                           class="form-control">
                                                    <label class="form-label">شارژ ماهانه</label>
                                                </div>
                                            </div>
                                        </div>
