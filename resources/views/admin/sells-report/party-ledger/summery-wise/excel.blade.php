        ...
        <table class="table table-striped table-bordered table-sm">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> {{  $item->total_flat_price  }} </td>
                    <td> {{  $item->car_parking_charge  }} </td>
                    <td> {{  $item->utility_charge  }} </td>
                    <td> {{  $item->additional_work_charge  }} </td>
                    <td> {{  $item->other_charge  }} </td>
                    <td> {{  $item->discount_or_deduction  }} </td>
                    <td> {{  $item->refund_additional_work_charge  }} </td>
                    <td> {{  $item->net_sells_price  }} </td>
                    <td> {{  $infos['total_collection'][$key]  }} </td>
                    <td> {{   $total_due  }} </td>
                ...
                <tr class="font-w-b">
                    ...
                    <td> {{  $total_flat_price  }} </td>
                    <td> {{  $total_car_parking_charge  }} </td>
                
                    <td> {{  $total_utility_charge  }} </td>
                    <td> {{  $total_additional_work_charge  }} </td>
                    <td> {{  $total_other_charge  }} </td>
                    <td> {{  $total_discount_or_deduction  }} </td>
                    <td> {{  $total_refund_additional_work_charge  }} </td>
                    <td> {{  $total_net_sells_price  }} </td>
                    <td> {{  $total_collection1  }} </td>
                    <td> {{   $total_due1  }} </td>
                    <td> </td>
                </tr>
            </tbody>
