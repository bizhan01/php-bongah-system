...
$createItemName = "Eidt" . $moduleName;
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-col-cyan pull-right">
                ...
                <li><a href="{{ route($ParentRouteName) }}"><i
                                class="{{ $breadcrumbMainIcon  }} "></i> مشتریان</a>
                </li>
                <li class="active"><i
                            class="material-icons">{{ $breadcrumbCurrentIcon  }}</i> ویرایش اطلاعات مشتری</li>
            </ol>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                ویرایش اطلاعات مشتری
                                <smAll>اطلاعات مشتری را ویرایش کنید</smAll>
                            </h2>
                                ...
                                <form class="form" id="form_validation" method="post"
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $item->father_or_husband_name }}" name="father_or_husband_name" type="text"
                                                           class="form-control">
                                                    <label class="form-label">نام پدر یا همسر</label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $item->mailing_address  }}" name="mailing_address" type="text"
                                                        class="form-control">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input value="{{ $item->nid  }}" name="nid" type="text"
                                                        class="form-control">
