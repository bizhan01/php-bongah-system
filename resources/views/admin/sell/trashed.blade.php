    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-col-cyan pull-right">
                ...
                <li class="active"><i
                            class="material-icons">{{ $breadcrumbCurrentIcon }}</i>فروش های لغو شده</li>
            </ol>
            <!-- Hover Rows -->
            <div class="row">
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        ...
                                        @foreach($items as $item)
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ App\Sell::withTrashed()->find($item->id)->customer->name  }}</td>
                                                <td>{{ App\Sell::withTrashed()->find($item->id)->branch->name  }}</td>
                                                <td>{{ $item->product_id }}</td>
                                                <td>{{ App\Sell::withTrashed()->find($item->id)->employee->name }}</td>
