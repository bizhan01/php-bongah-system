        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-col-cyan pull-right">
                ...
                <li><a href="{{ route($ParentRouteName) }}"><i
                                class="{{ $breadcrumbMainIcon  }}"></i>مدیریت فروش</a></li>
                <li class="active"><i
                            class="material-icons">{{ $breadcrumbCurrentIcon }}</i>فروش</li>
            </ol>
                                    ...
                                    <table class="table table-hover table-bordered table-sm">
                                        ...
                                        @foreach($items as $item)
                                            <tr>
                                                ...
                                                <td>{{ App\Sell::find($item->id)->customer->name  }}</td>
                                                <td>{{ App\Sell::find($item->id)->branch->name  }}</td>
                                                <td>{{ $item->product_id }}</td>
                                                <td>{{ App\Sell::find($item->id)->employee->name }}</td>
                                                <td>{{ $item->sells_date }}</td>
                                                ...
                                                <td class="tdTrashAction">
                                                    ...
                                                    <a @if ($delete==0)
                                                       ...
                                                       data-toggle="tooltip"
                                                       data-placement="top" title="پس گرفتن"> <i class="material-icons">keyboard_return</i></a>
                                                    ...
                                                    <a @if ($pdf==0)
                                                       ...
                                                       data-toggle="tooltip"
                                                       data-placement="top" title="پرینت"> <i
                                                    ...
                                                    <a @if ($pdf==0)
                                                       ...
                                                       data-toggle="tooltip"
                                                       data-placement="top" title="مدیریت مالی"> <i
