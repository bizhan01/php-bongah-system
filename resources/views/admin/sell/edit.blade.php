        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb breadcrumb-col-cyan pull-right">
                ...
                <li><a href="{{ route($ParentRouteName) }}"><i
                                class="{{ $breadcrumbMainIcon  }} "></i>فروش</a>
                </li>
                <li class="active"><i
                            class="material-icons">{{ $breadcrumbCurrentIcon  }}</i> ویرایش فایل فروش</li>
            </ol>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                ویرایش فایل فروش
                                <smAll>اطلاعات فایل فروش را ویرایش کنید</smAll>
                            </h2>
                                                ...
                                                <div class="form-line">
                                                    <select data-live-search="true" class="form-control show-tick"
                                                        ...
                                                        @foreach( App\Customer::All() as $customer )
                                                            <option @if ( $customer->id == $item->customer_id ))
                                                                    selected
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 field_area">
                                            <div class="form-group form-float">
                                                <div class="form-line" id="bs_datepicker_container">
                                                    <input autocomplete="off" value="{{ $item->sells_date }}"
                                                           name="sells_date"
                                                           type="text"
                                                           class="form-control"
