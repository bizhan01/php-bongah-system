...
class EmployeeController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'name' => 'sometimes|string|unique:employees,name,' . $id,
        ]);
    ...
    public function destroy($id)
    {
        ...
        $items = $this->parentModel::find($id);
        if (count($this->parentModel::find($id)->sells) > 0) {
    ...
    public function kill($id)
    {
        ...
        if (count($this->parentModel::withTrashed()->find($id)->sells) > 0) {
            Session::flash('error', "You can not delete it.Because it has Some Sells");
            return redirect()->back();
        }
